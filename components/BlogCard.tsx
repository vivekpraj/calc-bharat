...
export default function BlogCard({ article }: BlogCardProps) {
  return (
    <article className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 flex flex-col overflow-hidden">
      <div className="p-6 flex flex-col flex-1">
        ...
        <h2 className="text-gray-900 font-semibold text-base leading-snug mb-2 line-clamp-2">
          {article.title}
        </h2>
